...
namespace gem5
{
    namespace sDM
    {
        ...
        public:
            ...
            void AccessStats(std::string name, bool isaccess);
        };
        /**
         * @author
         * yqy
        ...
        public:
            ...
            private:
                ...
                int strategy = Evictstrategy::LRU;
            ...
            public:
                ...
                bool AccesswithLRU(Addr key, uint8_t *value, bool isread);
